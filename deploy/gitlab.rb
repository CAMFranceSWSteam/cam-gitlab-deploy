...
gitlab_rails['gitlab_email_from'] = 'gitlab.shared.bsa.lab@hpe.com'
gitlab_rails['gitlab_email_display_name'] ='CAM Shared GitLab'
gitlab_rails['gitlab_email_reply_to'] = 'noreply.gitlab.shared.bsa.lab@hpe.com'
...
###! **remember to close this block with 'EOS' below**
 gitlab_rails['ldap_servers'] = YAML.load <<-'EOS'
   main: # 'main' is the GitLab 'provider ID' of this LDAP server
     ...
     base: 'dc=bsa,dc=lab'
     user_filter: '(&(objectClass=person)(memberOf:1.2.840.113556.1.4.1941:=CN=GRP_LAB_Users,OU=Admin,DC=bsa,DC=lab))'
#     ## EE only
#     group_base: ''
#     admin_group: ''
#     sync_ssh_keys: false
...
gitlab_rails['smtp_address'] = "smtp1.hpe.com"
gitlab_rails['smtp_port'] = 25
# gitlab_rails['smtp_user_name'] = "smtp user"
# gitlab_rails['smtp_password'] = "smtp password"
gitlab_rails['smtp_domain'] = "hpe.com"
